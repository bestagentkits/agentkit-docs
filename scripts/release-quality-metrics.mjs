...
export const RELEASE_QUALITY_BASELINE = Object.freeze({
  ...
  sourceCommit: 'b007636dea3b756d4e7b185dfc14d13ca0541d3f',
  channels: ['beta', 'stable'],
  locales: ['en', 'vi'],
  deterministic: {
    outputBytes: 2_251_685_582,
    outputBudgetBytes: 2_814_606_978,
    fileCount: 18_290,
    fileCountBudget: 22_863,
    searchBytes: 19_911_284,
    searchBudgetBytes: SEARCH_ASSET_BUDGET_BYTES,
    searchPagesPerLocaleChannel: 376,
