...
Who it's for:
  Users who want a visual overview of their AgentKit projects and config.
...
What changes on disk:
  Reads ~/.agentkit/config.yaml for settings. In HTTP mode: writes ~/.agentkit/dashboard/state.json on start; removes it on stop.
