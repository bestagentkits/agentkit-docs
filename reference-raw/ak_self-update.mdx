...
Who it's for:
  Users who want AgentKit itself updated from the Cloudflare-backed release channel.

When to use it:
  Use this instead of `ak update` when updating the ak binary or staging a desktop update.
