...
- **Assumptions:** especially premises the proposal fails without, whether they
  can be verified now, and the cost of reversing course if they prove false.
...
5. **The Skill surfaces conflicts.** It compares materially different views and
   resolves them according to impact rather than majority alone, including each
   option's worst plausible case.
6. **The Skill builds the risk summary.** Risks receive severity and a concrete
   ...
   When uncertainty remains, the report also names an observable early signal.
...
- A risk summary with severity, observable early signals where applicable, and
  mitigation.
