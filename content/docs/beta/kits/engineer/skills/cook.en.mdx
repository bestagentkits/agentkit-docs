...
The default mode is interactive. It pauses at major review gates so you can
...
| --- | --- | --- |
| Default or `--interactive` | Runs the full workflow and pauses between major stages | Plan, testing, code review, and human decisions |
...
- The current stable and beta packages contain identical `ak:cook`
  content and invocations. Beta changes to Codex Hook reporting and projection
  do not change this Skill's workflow.
