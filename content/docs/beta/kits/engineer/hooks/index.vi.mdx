...
canonical đó cho command đã translate, thao tác ghi, rollback và ownership.
Parent có link, target không canonical và mọi link hay reparse point trên
Windows vẫn bị từ chối.
