...
run a kit Skill there. Released registry targets include Claude Code, Codex, and
Cursor; Grok Build is a local-source spike. AgentKit account authentication is a
separate step.
