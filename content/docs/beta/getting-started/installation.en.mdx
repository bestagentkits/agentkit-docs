...
run a kit Skill there. Released registry targets include Claude Code, Codex, Cursor, Grok, and Oh My
Pi (`omp`). Oh My Pi can also be selected by `ak run --target omp` for Skill
