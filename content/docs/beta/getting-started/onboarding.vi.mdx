...
Các bản cài project-native cho Claude Code, Codex, Cursor và Grok dùng remote
...
Với Cursor và Grok Build, hãy xác minh Skill đã cài bằng surface discovery và
invocation hiện tại của runtime đó trước khi xem onboarding là hoàn tất. Oh My
Pi khả dụng cho local Skill dispatch qua `ak run --target omp`, không phải route
cài Kit trong flow onboarding này.
