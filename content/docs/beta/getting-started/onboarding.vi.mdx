...
Các bản cài cho Claude Code, Codex, Cursor, Grok, Pi và Oh My Pi dùng remote
registry đã xác thực cùng kênh Kit `stable` theo mặc định. Với Claude Code, delivery dạng plugin yêu cầu
