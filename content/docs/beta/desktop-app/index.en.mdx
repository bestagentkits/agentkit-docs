...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.16.0-beta.8**. Artifact filenames,
...
## Published v2.16.0-beta.8 packages
...
v2.16.0-beta.8. The CLI remains available on both.
...
Desktop v2.16.0-beta.8 does not launch a Kit skill or agent run. Run the installed skill
