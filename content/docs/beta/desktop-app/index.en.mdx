...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.15.0-beta.3**. Artifact filenames,
...
## Supported v2.15.0-beta.3 packages
...
There is no v2.15.0-beta.3 Desktop package for Linux ARM64 or Windows ARM64. The CLI
...
Desktop v2.15.0-beta.3 does not launch a Kit skill or agent run. Run the installed skill
