...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.12.1-beta.2**. Artifact filenames,
...
## Supported v2.12.1-beta.2 packages
...
There is no v2.12.1-beta.2 Desktop package for Linux ARM64 or Windows ARM64. The CLI
...
Desktop v2.12.1-beta.2 does not launch a Kit skill or agent run. Run the installed skill
