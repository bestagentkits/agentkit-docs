...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.17.0-beta.12**. Artifact filenames,
...
## Published v2.17.0-beta.12 packages
...
v2.17.0-beta.12. The CLI remains available on both.
...
Desktop v2.17.0-beta.12 does not launch a Kit skill or agent run. Run the installed skill
