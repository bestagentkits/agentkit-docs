...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.18.0-beta.3**. Artifact filenames,
...
## Published v2.18.0-beta.3 packages
...
v2.18.0-beta.3. The CLI remains available on both.
...
Desktop v2.18.0-beta.3 does not launch a Kit skill or agent run. Run the installed skill
