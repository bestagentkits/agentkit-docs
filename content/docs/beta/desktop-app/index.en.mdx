...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.13.0-beta.7**. Artifact filenames,
...
## Supported v2.13.0-beta.7 packages
...
There is no v2.13.0-beta.7 Desktop package for Linux ARM64 or Windows ARM64. The CLI
...
Desktop v2.13.0-beta.7 does not launch a Kit skill or agent run. Run the installed skill
