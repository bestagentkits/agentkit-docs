...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.16.0-beta.5**. Artifact filenames,
...
## Published v2.16.0-beta.5 packages
...
v2.16.0-beta.5. The CLI remains available on both.
...
Desktop v2.16.0-beta.5 does not launch a Kit skill or agent run. Run the installed skill
