...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.15.0-beta.22**. Artifact filenames,
...
## Published v2.15.0-beta.22 packages
...
v2.15.0-beta.22. The CLI remains available on both.
...
Desktop v2.15.0-beta.22 does not launch a Kit skill or agent run. Run the installed skill
