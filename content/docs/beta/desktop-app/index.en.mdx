...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.16.1-beta.2**. Artifact filenames,
...
## Published v2.16.1-beta.2 packages
...
v2.16.1-beta.2. The CLI remains available on both.
...
Desktop v2.16.1-beta.2 does not launch a Kit skill or agent run. Run the installed skill
