...
There is no v2.13.0-beta.20 Desktop package for Linux ARM64 or Windows ARM64. The CLI
...
Desktop v2.13.0-beta.20 does not launch a Kit skill or agent run. Run the installed skill
