...
detected coding agents, from the Kit catalog used by Desktop v2.15.0-beta.3. You can
...
Desktop v2.15.0-beta.3 does not start a Kit skill or agent run. Launch the installed
