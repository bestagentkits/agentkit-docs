...
detected coding agents, from the Kit catalog used by Desktop v2.13.0-beta.12. You can
...
Desktop v2.13.0-beta.12 does not start a Kit skill or agent run. Launch the installed
