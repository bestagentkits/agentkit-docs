...
detected coding agents, from the Kit catalog used by Desktop v2.12.1-beta.6. You can
...
Desktop v2.12.1-beta.6 does not start a Kit skill or agent run. Launch the installed
