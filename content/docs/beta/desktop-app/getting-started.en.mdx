...
detected coding agents, from the Kit catalog used by Desktop v2.16.0-beta.5. You can
...
Desktop v2.16.0-beta.5 does not start a Kit skill or agent run. Launch the installed
