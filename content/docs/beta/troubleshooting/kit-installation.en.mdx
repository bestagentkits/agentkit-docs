...
| Exit `5` | The documented not-found class for a Kit missing from an explicit local `--kits-dir` | Check the Kit name and selected local source; this path can still surface as exit `1` in v2.7.0. |
...
Use the error text together with the exit code; v2.7.0 does not attach the more
