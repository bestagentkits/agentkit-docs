...
1. Kit name.
2. Target runtime: `claude-code`, `codex`, `cursor`, or `grok`.
...
For local harness dispatch, `ak run <kit>/<skill> --target omp` routes through
Oh My Pi; that path is separate from runtime-native Skill discovery.
