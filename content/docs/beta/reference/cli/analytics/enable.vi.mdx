...
Từ CLI, lệnh này là cách duy nhất để bật index. Desktop app và dashboard
`ak config start` tự bật index chưa từng được thiết lập, nhưng không bao giờ bật
lại index bạn đã disable hoặc delete; sau `disable` hoặc `delete`, hãy chạy lệnh
này để bật lại.
