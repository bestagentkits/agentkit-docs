...
description: "Codex agent MCP dispatch runtime (ADR 0014)."
generated: true
---

## ak codex-agent-runtime

Codex agent MCP dispatch runtime (ADR 0014).
...
* [ak codex-agent-runtime serve](./ak_codex-agent-runtime_serve)	 - Run the Codex agent MCP server over stdio (per ADR 0014).
