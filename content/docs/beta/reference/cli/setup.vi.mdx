...
| --- | --- | --- |
| `--adapter <ids>` | Runtime được phát hiện | Cấu hình tập adapter đã đăng ký, phân tách bằng dấu phẩy: `claude-code`, `codex`, `cursor`, `dsh`, `grok` hoặc `omp`. Projection Kit Pi được cài bằng `ak kit init --target pi`; nó không phải setup adapter ở đây. |
