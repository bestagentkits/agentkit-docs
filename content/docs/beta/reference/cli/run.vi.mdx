...
<Callout type="warning">
  ...
  là harness dispatch cục bộ qua Oh My Pi. Tuyến này tách biệt với
  `ak kit init <kit> --target omp` có thể cài đặt và không thay thế projection
  Kit ở project hoặc global.
</Callout>
