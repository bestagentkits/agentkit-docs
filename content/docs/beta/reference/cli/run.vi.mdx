---
title: ak run
description: Resolve local Kit skill và stream qua Claude Code, Codex, Cursor hoặc spike Grok Build với hành vi stdin, timeout, output và dependency rõ ràng.
---
