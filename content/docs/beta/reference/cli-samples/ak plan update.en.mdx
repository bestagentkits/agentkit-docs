...
- [Complete `ak plan update` facts](../cli/ak_plan_update)
- [Show the resulting plan](../cli/ak_plan_show)
- [Rebuild file-owned fields](../cli/ak_plan_reindex)
- [Close the plan lifecycle](../cli/ak_plan_close)
- [Pin a worktree's current plan](../cli/ak_plan_use)
