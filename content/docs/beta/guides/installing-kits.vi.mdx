...
trạng thái vòng đời đã cài. Đích hiển thị trong preview là nguồn chính xác khi
môi trường ghi đè runtime root thông thường.
...
nó không bao giờ có nghĩa xóa toàn bộ `.claude`, `.codex` hoặc thư mục runtime
của người dùng.
