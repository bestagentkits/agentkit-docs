...
Normal runtime installs use `--target claude-code`, `--target codex`, or
...
install for each runtime you use.
...
| AGY for your user | `ak kit init engineer --target agy --global` |
| Portable export | `ak kit init engineer --target portable --out DIR` |
