...
```mermaid
flowchart TB
  accTitle: Từ Kit đã xác minh đến các bề mặt runtime
  accDescr: Registry yêu cầu xác thực cung cấp bản phát hành Kit đã xác minh cho AgentKit CLI. CLI chuyển Kit qua adapter thành các bề mặt của Claude Code, Codex hoặc Cursor.
