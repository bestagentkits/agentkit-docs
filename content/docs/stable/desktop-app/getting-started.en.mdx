...
detected coding agents, from the Kit catalog used by Desktop v2.17.0. You can
...
Desktop v2.17.0 does not start a Kit skill or agent run. Launch the installed
