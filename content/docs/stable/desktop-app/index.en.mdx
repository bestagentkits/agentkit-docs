...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.16.0**. Artifact filenames,
...
v2.16.0. The CLI remains available on both.
...
Desktop v2.16.0 does not launch a Kit skill or agent run. Run the installed skill
