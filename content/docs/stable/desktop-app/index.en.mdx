...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.12.0**. Artifact filenames,
...
There is no v2.12.0 Desktop package for Linux ARM64 or Windows ARM64. The CLI
...
Desktop v2.12.0 does not launch a Kit skill or agent run. Run the installed skill
