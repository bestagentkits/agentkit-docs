...
<Callout type="info">
  These pages describe AgentKit Desktop **v2.15.0**. Artifact filenames,
...
v2.15.0. The CLI remains available on both.
...
Desktop v2.15.0 does not launch a Kit skill or agent run. Run the installed skill
