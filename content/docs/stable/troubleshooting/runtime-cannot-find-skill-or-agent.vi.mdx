...
Sau khi đổi nơi lưu hook state hoặc cài lại hook registration, hãy restart các
session Claude Code và Codex đang chạy trước khi kiểm tra. Session cũ có thể vẫn
giữ hook inventory và state path trước đó.
