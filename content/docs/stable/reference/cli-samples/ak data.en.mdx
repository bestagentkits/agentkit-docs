...
- [Complete `ak data` command facts](../cli/ak_data)
- [Inspect data defaults](../cli/ak_data_status)
- [Manage content-search shards](../cli/ak_content-search)
- [Create an operational snapshot](../cli/ak_backups_create)
