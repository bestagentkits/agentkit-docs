...
The success summary reports installed Hook events and scripts when present.
Review any Hook warnings: a successful install can still preserve or omit
runtime behavior that the selected target cannot represent.
