---
title: ak run
description: Resolve local Kit skill và stream qua Claude Code, Codex hoặc Cursor với hành vi stdin, timeout, output và dependency rõ ràng.
---
...
| Cờ | Mặc định | Mô tả |
| --- | --- | --- |
| `--target <adapter>` | `claude-code` | Chọn `claude-code`, `codex` hoặc `cursor`. |
