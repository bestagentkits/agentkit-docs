...
What changes on disk:
  Read-only. Reads ~/.agentkit/auth/session.json (AGENTKIT_HOME overrides the base dir) and reads AGENTKIT_REGISTRY_URL (default: $AGENTKIT_REGISTRY_URL, then dev/staging https://staging.agentkit.best or release https://agentkit.best) to resolve grants.
