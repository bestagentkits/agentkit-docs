...
What it does:
  Re-emit an installed kit with force enabled. This refreshes active Claude Code native or Claude Code/Codex plugin output and unloads generated files that disappeared from the kit source, such as retired agents, rules, hooks, or commands.
