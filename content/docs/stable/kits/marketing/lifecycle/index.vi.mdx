...
hình ownership và [`ak audit`](../../../reference/cli/ak%20audit) để biết tùy chọn
chính xác.
...
self-update`](../../../reference/cli/self-update) và [`ak
...
Xem [`ak kit uninstall`](../../../reference/cli/kit-uninstall) để biết flag
...
recover`](../../../reference/cli/recover) và [`ak backups
restore`](../../../reference/cli/backups-restore). Để chẩn đoán sau kết quả
