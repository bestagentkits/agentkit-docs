...
3. **Skill phỏng vấn bạn từng câu.** Skill bắt đầu bằng why, đưa ra
   counterargument mạnh nhất, so sánh alternative và thử budget, timeline,
   maintenance, skill cùng stack lock-in.
...
6. **Skill đưa verdict.** Skill nêu điều nên làm, không nên làm, alternative đơn
   giản hoặc rẻ hơn, benefit, trade-off và đường đi đề xuất.
...
- Stable và beta package behavior cùng flag `ak:advise` giống nhau. Thay đổi
